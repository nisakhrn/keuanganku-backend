        ...
        <div className="section-container">
          ...
          <div className="features-grid">
            <div className="feature-card">
              ...
              <p className="feature-desc">Kelola kondisi finansial Anda dengan mudah melalui tampilan ringkas yang menampilkan saldo, pemasukan, pengeluaran, dan grafik keuangan secara real-time</p>
            </div>
            <div className="feature-card">
              <div className="feature-icon">📝</div>
              <h3 className="feature-title">Riwayat Transaksi</h3>
              <p className="feature-desc">Pantau semua transaksi Anda dengan riwayat lengkap dan detail yang terorganisir.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="section-container">
          ...
          <div className="benefits-content">
            ...
            <div className="benefits-cta-card">
              ...
              <p className="cta-card-desc">Bergabunglah dengan ribuan pengguna yang sudah merasakan kemudahan mengelola keuangan dengan KeuanganKu.</p>
        ...
        <div className="footer-container">
          <div className="footer-grid">
            <div className="footer-col">
              ...
              <p className="footer-desc">Solusi cerdas untuk mengelola keuangan pribadi Anda.</p>
            </div>
            <div className="footer-col">
